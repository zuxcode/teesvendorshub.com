          ...
          <tr>
            <td style="padding:40px 30px;">
              ...
              <div style="background:#f8fafc; padding:20px; border-radius:8px; margin:20px 0;">
                ...
                <p style="margin:0 0 10px;"><strong>Price:</strong> ₦${order.price.toLocaleString()}</p>
                <p style="margin:0;"><strong>Payment Method:</strong> ${order.paymentMethod === "manual" ? "Bank Transfer" : order.paymentMethod === "wallet" ? "Wallet" : "Crypto"}</p>
              </div>
